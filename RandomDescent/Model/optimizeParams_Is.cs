...
{
	public class OptimizeParams_Is : IOptimize, IVAX, IInaccuracy
	{
		...
		public OptimizeParams_Is(double[] I, double[] U, double Is, double f, double R, double IKF, double[] FPar)
		{
