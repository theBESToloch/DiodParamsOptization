...
{
	public class Optimize2Params_Is_fi_1 : IOptimize, IVAX, IInaccuracy
	{
		...
		public Optimize2Params_Is_fi_1(double[] I, double[] U, double Is, double f)
		{
			ISy = new List<double>();
			fy = new List<double>();
			...
			this.FiPar = new OptimizeParams(new double[] { 1 });
