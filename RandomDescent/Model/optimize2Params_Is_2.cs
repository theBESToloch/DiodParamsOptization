...
{
	public class Optimize2Params_Is_2 : IOptimize, IVAX, IInaccuracy
	{
		...
		public Optimize2Params_Is_2(double[] I, double[] U, double Is, double f)
		{
			ISy = new List<double>();
			fy = new List<double>();
		...
		{
			return Is * (1 + IsPar[0] * Math.Pow(U, 4) + IsPar[1] * Math.Pow(U, 8)) /(1+ IsPar[2] * Math.Pow(U, 4));
		}
